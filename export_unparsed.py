...
if __name__ == "__main__":
    ...
    onnxmodel = onnx.load('/Data/Signals/Sat_proj/epoch2275_best_SGD_square_1_quantized.onnx')
    weights = onnxmodel.graph.initializer
    torchmodel = torch.load('/usr/src/Sat_proj/yolov5/epoch2275_best_SGD_square_1.pt')
    INTIALIZERS = onnxmodel.graph.initializer
    Weight = []
